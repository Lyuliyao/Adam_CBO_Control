...
value_test2 = problem_configure["fcn_Qs"](x)*N_mv+N_mv*problem_configure["fcn_Q"](x)*0.01
np.savez(f"./result_{dim}/value_test_mv_{N_mv}_gaussian.npz",value_test1=value_test1,value_test2=value_test2)
